...
class SQLAlchemyContentDatastore(SQLAlchemyDatastore, Datastore):
    ...
    def content_query(self):
        # TODO: add permission filters here
        return self.content_model.query

    @property
    def category_query(self):
        # TODO: add permission filters here
        return self.category_model.query
    ...
    def find_content(self, one=False, **kwargs):
        ...
        query = self.content_query.options(joinedload(Content.categories)).options(joinedload(Content.allowed_roles))
    ...
    def find_category(self, **kwargs):
        return self.category_query.filter_by(**kwargs).first()
    ...
    def create_content(self, name, content, description, **kwargs):
        ...
        self.put(self._content_model(name=name, content=content, description=description, **kwargs))
        return True
    ...
    def create_category(self, category, description):
        ...
        self.put(self._category_model(name=category,
